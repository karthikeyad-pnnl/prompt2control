# ASHRAE Guideline 36-2024 Addendum y Report

## Inventory
- **Description:** Fixes an error the MZVAV AHUs with separate minimum outdoor air dampers which could cause both the outside air and return air damper to close when the supply air temperature control loop is wound up and minimum outdoor airflow control is enabled.
- **ASHRAE approval date:** August 30, 2024
- **Affected sections:** 5.16.4.4; 5.16.5.4
...
- **Secondary functional categories:** Outdoor-air control, Economizer control, Airflow control, Equipment enable/disable, Process control
...
- **Operational interpretation:** Fixes an error the MZVAV AHUs with separate minimum outdoor air dampers which could cause both the outside air and return air damper to close when the supply air temperature control loop is wound up and minimum outdoor airflow control is enabled.. The affected behavior should be confirmed against the full section and controlled addendum source before implementation.
